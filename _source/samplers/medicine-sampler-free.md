...
| Specialty | 2023 | 2025 | **Fall 2026** | 3-yr move | Band |
|---|---|---|---|---|---|
...
|---|---|
| Clinical documentation and letters | Physical examination |
| Coding and billing | Procedures and surgery |
| Guideline and drug interaction lookup | Deciding under genuine uncertainty |
| First-pass image reading | Owning the outcome when it goes wrong |
| Record summarization | Telling a family bad news |
| Triage and risk stratification | Judgment when the patient doesn't match the textbook |
...
| How hard will it be to land that first job? | 1.5 | ↓ strongest protection in the index |
| Does it have to be done in person, with your hands? | 8.0 | ↓ strong protection |
...
- **[Pharmacy](#)** — 4.9, the surprise of the healthcare group
...
| **The radiology debate in full** — including the strongest case against our score | | ✓ |
| **The honest downsides** — training length, cost, attrition, burnout | | ✓ |
| **What's genuinely good about it** — what doctors say, and the satisfaction data | | ✓ |
| **Who this work suits, and who it doesn't** | | ✓ |
| **The AI-native advantage** — how to prepare, and why this cohort has an opening | | ✓ |
| **Routes in** — direct entry, graduate entry, international routes | | ✓ |
| **Choosing a specialty** — how the AI dimension should and shouldn't weigh | | ✓ |
| **Program evaluation checklist** | | ✓ |
| **Questions to ask a medical school** — plus red flags | | ✓ |
