...
|---|---|---|---|---|---|
| Community / medical interpreting | 3.5 | 3.9 | **4.3** | +0.8 | Low–Moderate |
| Legal / court interpreting | 3.6 | 3.9 | **4.3** | +0.7 | Low–Moderate |
| Conference / simultaneous interpreting | 4.2 | 4.6 | **5.1** | +0.9 | Moderate |
| Literary translation | 5.9 | 6.5 | **7.0** | +1.1 | High |
| Localization / technical translation | 7.1 | 7.7 | **8.2** | +1.1 | High |
...
|---|---|
| Document and business translation | Being physically present in a courtroom |
| Website and software localization | Reading a frightened patient's meaning, not just their words |
| Subtitling and transcription | Legal accountability for an accurate rendering |
| Technical manuals and specifications | Simultaneous interpreting under live pressure |
| First-draft literary translation | Cultural judgment where the stakes are personal |
| Multilingual content production | Being the person a non-English speaker trusts in the room |
...
| How often does the job hit genuinely new, high-stakes situations? | 2.5 | ↓ almost none |

### One factor, worked through in full

*So you can see what the analysis actually looks like — in the one profession where the automation is essentially complete.*

**How much of this job can AI already do? — rated 9.5, and this is what a finished automation looks like**
...
## What's in the translation Career Value Guide

This sampler tells you where translation stands. The full Career Value Guide tells you what to do about it.
...
| **How durable each protection is** — including remote interpreting | | ✓ |
| **What actually happened to the translation market** — and what it predicts elsewhere | | ✓ |
| **The honest downsides** — rates, freelance precarity, certification costs | | ✓ |
...
| **Routes in** — interpreting certification, domain pairing, diplomacy and law | | ✓ |
| **Where a languages degree leads** — beyond translation | | ✓ |
| **Program evaluation checklist** — interpreting training, cultural competence | | ✓ |
