...
const FIELDS = {
  ...
  "law": {
    ...
    steps: [
      ...
      "<b>Specialise where the stakes and the ambiguity are high.</b> Regulatory, litigation and complex advisory work resist automation because the cost of being wrong is enormous and the situations are genuinely novel.",
    ...
    timeline: [
      ...
      { w: "Years 2&ndash;3", b: "Specialise into a high-stakes, high-ambiguity area &mdash; litigation, regulatory, in-house &mdash; and build the client relationships no model can hold." },
    ],
    traps: [
      ...
      "<b>Assuming the bar licence alone protects you.</b> It protects the courtroom, not the back office.",
  ...
  "accounting": {
    label: "Accounting",
    headline: "Accounting: it all turns on the licence. Get to the side of it software can&rsquo;t hold.",
    intro: "The Active guide told " + pick("your kid", "you") + " to steer toward the protected adjacent track. In accounting the split is stark: the CPA signature is a legal monopoly no software can hold, and everything below it is among the most automatable work we score. Here&rsquo;s the bridge to the licence.",
    ...
    steps: [
      "<b>Get the licence, and get it early.</b> The CPA is the whole moat &mdash; a legal monopoly on the signature. Everything about the safe lane starts with being the person allowed to sign.",
    ...
    timeline: [
      { w: "Study &amp; exam", b: "Point everything at the CPA &mdash; the coursework, the hours, the exam. The licence is the single highest-return move in the whole field." },
