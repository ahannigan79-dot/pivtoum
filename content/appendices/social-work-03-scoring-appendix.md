# Technical scoring appendix — Social Work
...
### Statutory child protection — **3.3** (Low)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 6.2 | 6.9 | **7.4** | 2.59 |
...
| Judgment under novelty | 10% | 9.5 | 9.5 | **9.5** | 0.05 |
| | | | | **Total** | **3.29 → 3.3** |

### Adult safeguarding (statutory) — **3.8** (Low)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 6.8 | 7.6 | **8.4** | 2.94 |
...
### Clinical social work (LCSW) — **4.3** (Low)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 6.9 | 7.9 | **8.7** | 3.04 |
...
### Medical / hospital social work — **4.7** (Moderate)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 7.4 | 8.4 | **9.1** | 3.18 |
...
### Community / case management — **5.4** (Moderate)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 7.5 | 8.5 | **9.4** | 3.29 |
...
### Policy & programme administration — **6.1** (Moderate–High)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 5.3 | 6.5 | **7.4** | 2.59 |
...
|---|---|---|---|---|
| 2023 | 6.2 | 1.5 | 0.4 | **2.8** |
| 2025 | 6.9 | 1.8 | 0.4 | **3.1** |
| Fall 2026 | 7.4 | 2.0 | 0.4 | **3.3** |

**Movement decomposition:** automatability contributed **+0.42** and entry-path erosion **+0.07**, for a total of **+0.5** points over three years.
