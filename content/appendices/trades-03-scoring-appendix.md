# Technical scoring appendix — Skilled Trades
...
### Electrician — service & maintenance — **2.5** (Very low)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 3.9 | 4.4 | **4.9** | 1.72 |
...
### Plumbing / HVAC — service — **2.6** (Very low)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 4.1 | 4.5 | **5.0** | 1.75 |
| Entry-path erosion | 15% | 1.5 | 1.8 | **2.0** | 0.3 |
| Physical / embodied | 15% | 9.5 | 9.5 | **9.5** | 0.07 |
| Human trust / accountability | 15% | 8.5 | 8.5 | **8.5** | 0.22 |
| Regulatory / licensing | 10% | 8.8 | 8.8 | **8.8** | 0.12 |
| Judgment under novelty | 10% | 8.8 | 8.8 | **8.8** | 0.12 |
| | | | | **Total** | **2.59 → 2.6** |

### Welding & fabrication — site work — **3.2** (Low)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 4.5 | 5.0 | **5.4** | 1.89 |
...
### Construction site trades — **3.4** (Low)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 4.3 | 5.0 | **5.7** | 1.99 |
...
### Production line / prefab / modular — **5.0** (Moderate)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 3.9 | 5.1 | **6.4** | 2.24 |
...
**Electrician — service & maintenance**

| Edition | A | E | Protection deficit (fixed) | Score |
|---|---|---|---|---|
| 2023 | 3.9 | 1.5 | 0.5 | **2.1** |
| 2025 | 4.4 | 1.8 | 0.5 | **2.3** |
| Fall 2026 | 4.9 | 2.0 | 0.5 | **2.5** |
