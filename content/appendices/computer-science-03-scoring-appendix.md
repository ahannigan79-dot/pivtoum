# Technical scoring appendix — Computer Science
...
### Embedded / safety-critical systems — **4.7** (Moderate)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 4.6 | 5.3 | **6.2** | 2.17 |
| Entry-path erosion | 15% | 3.0 | 3.5 | **4.0** | 0.6 |
...
### Security engineering — **5.3** (Moderate)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 4.2 | 5.1 | **5.8** | 2.03 |
...
### Senior engineer / architect — **5.4** (Moderate)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 3.6 | 4.5 | **5.4** | 1.89 |
| Entry-path erosion | 15% | 3.0 | 3.5 | **4.0** | 0.6 |
| Physical / embodied | 15% | 1.0 | 1.0 | **1.0** | 1.35 |
| Human trust / accountability | 15% | 7.0 | 7.0 | **7.0** | 0.45 |
...
### ML / AI engineering — **6.0** (Moderate–High)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 4.5 | 5.5 | **6.5** | 2.27 |
| Entry-path erosion | 15% | 3.0 | 4.0 | **5.0** | 0.75 |
| Physical / embodied | 15% | 1.0 | 1.0 | **1.0** | 1.35 |
...
### Backend / infrastructure — **6.8** (Moderate–High)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 5.3 | 6.6 | **7.5** | 2.62 |
| Entry-path erosion | 15% | 4.5 | 5.5 | **6.0** | 0.9 |
| Physical / embodied | 15% | 1.0 | 1.0 | **1.0** | 1.35 |
...
### Frontend / application development — **7.6** (High)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 6.0 | 7.3 | **8.5** | 2.97 |
| Entry-path erosion | 15% | 5.5 | 6.5 | **7.0** | 1.05 |
| Physical / embodied | 15% | 1.0 | 1.0 | **1.0** | 1.35 |
...
### Entry-level developer — **8.1** (High)

| Factor | Weight | 2023 | 2025 | **2026** | Contribution to 2026 score |
|---|---|---|---|---|---|
| Task automatability | 35% | 5.1 | 7.4 | **8.8** | 3.08 |
| Entry-path erosion | 15% | 5.0 | 7.0 | **8.5** | 1.27 |
| Physical / embodied | 15% | 1.0 | 1.0 | **1.0** | 1.35 |
...
|---|---|---|---|---|
| 2023 | 4.6 | 3.0 | 1.92 | **4.0** |
| 2025 | 5.3 | 3.5 | 1.92 | **4.3** |
| Fall 2026 | 6.2 | 4.0 | 1.92 | **4.7** |

**Movement decomposition:** automatability contributed **+0.56** and entry-path erosion **+0.15**, for a total of **+0.7** points over three years.
