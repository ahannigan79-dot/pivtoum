**The short answer, if you're weighing whether to study agriculture: it's reasonably protected, and it carries the least certain scores in the index.** Living things do not behave like production lines, which is the protection. But agricultural technology is advancing quickly in exactly the controlled settings where automation always arrives first, and that's where our long-horizon caveat about physical AI has the most bite on the path you'd be choosing.
...
Not in the field. It is transforming how field work is done, which is a different thing. That distinction is the one to plan your route around: the outdoor, hands-on end is protected and the data-and-screen end is not.
...
**The general lesson before you commit: ask whether automation in a field is sold to the worker or to the employer.** When a person buys a tool that makes them more capable, the tool tends to raise their value. When an employer buys a tool that replaces a function, it tends to lower it. Same technology, opposite effect on the person, and the score alone will not tell you which is happening.
...
## Is an agriculture degree still worth it in 2026?
...
**Farming itself is capital-intensive**, and the honest obstacle for most people entering it has nothing to do with automation. The community gives those non-AI downsides their own treatment in the Learn library — alongside the routes in that do not require inheriting or buying a farm, and which versions of the path actually hold up.

**This is also the category with our largest genuine unknown.** Physical protection is the strongest shield today and the one we rank least durable, and agriculture sits in the middle of that question. Field robotics is advancing fastest in orchards, glasshouses and row crops — structured settings — and slowest in mixed farming, livestock and uneven terrain. Enter now and you'll work for forty years, and the boundary between those two categories is likely to move — so aim from the start at the outdoor, judgment-heavy end rather than the indoor, structured one.
...
## What's in your agriculture AI Exposure Report
This report tells you where agriculture and environment stand. The community is how you act on it.
