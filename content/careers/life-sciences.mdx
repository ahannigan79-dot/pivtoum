**The short answer, if you work in the life sciences: your exposure comes down to where your work physically happens.** The protected work is hands-on, in a lab or a field, with judgment about physical systems. The exposed work is analysis at a screen — which is exactly where many assume the future lies.
...
Anyone choosing between wet lab and computational biology usually assumes the computational route is the modern, future-proof one. Our scoring says the opposite, and this factor is why.
...
**The uncomfortable version:** protein structure prediction, sequence annotation and much of standard genomic analysis are now substantially automated, and were among the earliest scientific tasks to be. Moving toward bioinformatics because it is technical and modern can mean moving toward the most exposed part of your own discipline.
...
The move is toward where the work physically happens — the bench, the field, the clinic — and away from the screen-based analysis that scores worst. If your day-to-day is wet lab, clinical trials or fieldwork, your exposure is moderate and the embodied craft is what protects you. If it is bioinformatics or standard computational analysis, that is the most exposed part of the discipline, and moving your work closer to the physical or the regulated end is the highest-leverage thing you can do for your own security.

And one honest note on demand: AI-driven drug discovery is genuinely creating jobs, some of them the most interesting work in the sector. Most of them require a doctorate and computational skill, and they sit in the part of the field our scoring rates most exposed. Both things are true, and the growth and the exposure are in the same place.
