**The short answer, if you're weighing whether to study journalism: not as a route to a newsroom desk job — that path is close to closed, and mostly for reasons that have nothing to do with AI.** Journalism holds up as a *skill set* — verification, sourcing, clear writing under pressure, working a beat — pointed at investigative work, specialist reporting, or paired with a domain.
...
You should weigh the industry's finances first and our score second. We would rather say that plainly than claim more for our own factor than it deserves.
...
Which versions actually hold up, where they point, and the question worth putting to any program to tell a career-building curriculum from a content-production one, are what your Career Map sets out inside the community.
