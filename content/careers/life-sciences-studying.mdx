...
**Which routes actually hold up, and the questions worth putting to any program about where its graduates end up, are mapped out for you inside the community** — alongside the honest downsides of the degree-alone path and the postgraduate and specialized paths that make biology pay off.
