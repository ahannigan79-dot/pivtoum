**The short answer, if you're weighing whether to study dentistry: it's one of the more defensible routes on this list, and one that's routinely overlooked by people who say "medicine" without realizing it is a separate path.** Precise physical work on an anxious person, comprehensively licensed, with practice ownership as a realistic destination. The genuine trade-offs are physical wear and running a business, not automation.
...
**Against, and none of it is about AI:** the genuine trade-offs are physical wear and running a business. Our index measures automation exposure, not whether a field is a comfortable living, and that's worth weighing separately before you commit. Inside the community, those honest downsides get their own treatment in the Learn library — alongside which version of a dental career actually holds up for you, and the routes in worth a look, including the hygienist path for someone drawn to the clinical work rather than to diagnosis, surgery and business ownership.
