...
What still works as a route in has less to do with the score than with how you enter and how deep you go. The full guide covers those routes in, which versions of the path actually hold up, and how to judge whether a program builds adversarial thinking or just tool operation.
