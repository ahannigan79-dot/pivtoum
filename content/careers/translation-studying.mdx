**The short answer, if you're weighing whether to study languages for a career in translation: not for that.** Document translation is effectively gone and has been for several years. Interpreting — a human physically present, legally accountable, in a room where it matters — is a different and genuinely protected career that happens to use the same languages, and it's the destination to aim at.
...
**The translation career specifically has been hollowed out**, and honest programs should say so. A degree sold as preparation for translating documents is preparing you for the most automated work in this index.

The distinction worth carrying in as you choose: AI has largely solved translation and has not solved communication. Knowing what a sentence means is now free. Knowing what should be said, to whom, in what register, in a room where it matters, is not — which is why interpreting is protected and document work is not.

**Those other reasons — and the line between a serious program and a cynical one — are what the community is for.** The Learn library gives the honest downsides their own treatment alongside where a languages degree still leads beyond translation, the adjacent and genuinely protected paths it opens, and what to ask any program before you enrol.
