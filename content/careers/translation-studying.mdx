...
**Those other reasons — and the line between a serious program and a cynical one — are what the full guide is for.** It gives the honest downsides their own treatment alongside where a languages degree still leads beyond translation, the adjacent and genuinely protected paths it opens, and what to ask any program before you enrol.
