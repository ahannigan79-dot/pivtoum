...
Which versions of the work hold up — and which point straight at the automated end — is the whole question, and it turns on the shape of the work rather than the score. The full guide covers which parts of the field actually hold up, the routes into the protected end, and how to judge where your own role is really pointed.
