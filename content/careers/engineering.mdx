**The short answer, if you work in engineering: your exposure depends almost entirely on how close your work sits to the stamp and the site.** Software pays more at entry, where entry survives. Engineering holds licensure, site work, and legal accountability for things that must not fail — and that is what protects the licensed end of it.
...
That is the single most consequential contrast in this index if your work sits close to the build — and it points to where the ground under you is firmest: the stamp, the site, and the calls where failure is catastrophic.
