**The short answer, if you work in agriculture: you're reasonably protected, and yours are the least certain scores in the index.** Living things do not behave like production lines, which is the protection. But agricultural technology is advancing quickly in exactly the controlled settings where automation always arrives first, and that's where our long-horizon caveat about physical AI has the most bite on your exposure.
...
Not in the field. It is transforming how field work is done, which is a different thing. Where your own role sits on that line is what your exposure turns on.
...
It is a genuinely durable place to be for a particular kind of person, and it is poorly served by careers advice.

**The environmental and land-management side is growing** for reasons entirely independent of AI — climate adaptation, regulation, restoration funding and land-use change. That demand is real and not cyclical in the way construction is, and it is where the room to move is opening.

**Farming itself is capital-intensive**, and the honest obstacle for most people in it has nothing to do with automation. The community gives those non-AI downsides their own treatment in the Learn library — alongside the routes that do not require inheriting or buying a farm, and which versions of the work actually hold up.

**This is also the category with our largest genuine unknown.** Physical protection is the strongest shield today and the one we rank least durable, and agriculture sits in the middle of that question. Field robotics is advancing fastest in orchards, glasshouses and row crops — structured settings — and slowest in mixed farming, livestock and uneven terrain. If you have decades of work ahead of you, the boundary between those two categories is likely to move under you, and the safer ground is the outdoor, judgment-heavy, less structured end.
