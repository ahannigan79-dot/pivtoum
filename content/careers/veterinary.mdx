**The short answer, if you work in veterinary medicine: this is one of the safest careers we score, full stop.** The reasons to think hard about the field are entirely different ones — competitive entry, high training debt relative to earnings, and an emotional load that the profession itself now discusses openly.
...
There's barely a defensive move to make on AI — clinical veterinary work sits near the floor of this index, and the automation arriving is landing on the administration vets complain about most. The only exposed corner is the lab and diagnostic end, pattern work on structured samples away from the animal, which scores 5.4 against the low-2s of clinical practice. As long as your work involves examining, handling and treating a live patient, the ground under you is about as firm as this index gets.

**So the honest concerns are different ones, and the profession names them openly** — fiercely competitive entry, training debt that is high relative to earnings, and a well-documented emotional load all predate AI, and our index measures automation exposure, not whether a field is a comfortable living. Inside the community, those downsides get their own honest treatment in the Learn library — alongside which routes actually hold up and the adjacent paths worth a look.
