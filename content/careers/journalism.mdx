**The short answer, if you work in journalism: the newsroom desk job is close to closed — mostly for reasons that have nothing to do with AI — but the craft holds up.** Verification, sourcing, clear writing under pressure, working a beat: that skill set still has value, pointed at investigative work, specialist reporting, or paired with a domain.
...
Read the industry's finances first and our score second. We would rather say that plainly than claim more for our own factor than it deserves.
...
The move is toward the reporting that can't be done from a desk. If your work is still mostly rewriting wire copy and aggregating, that's the exposed layer, and the industry's economics are removing it faster than the technology alone would. The durable ground is original reporting — investigative work, a specialist beat, sources who trust you, documents nobody published.

The craft you already have — verification, sourcing, interviewing, working a beat and writing clearly under pressure — is genuinely valuable and increasingly scarce, particularly as the volume of unverified content rises. The question is where you point it: at the desk that's automating, or at the reporting that isn't. Inside the community, your Career Map sets out where the roles have migrated and how to get to them.
...
## What's in your journalism AI Exposure Report
This report tells you where journalism stands. The community is how you act on it.
