...
What works as a route in has less to do with the score than with how you enter and how deep you aim to go — the adversarial end is the destination worth aiming at from day one. Inside the community, the Learn library covers those routes in, which versions of the path actually hold up, and how to judge whether a program builds adversarial thinking or just tool operation.
