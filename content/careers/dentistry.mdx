...
**Against, and none of it is about AI:** the genuine trade-offs are physical wear and running a business. Our index measures automation exposure, not whether a field is a comfortable living, and that's worth weighing separately. The full guide gives those honest downsides their own treatment — alongside which version of a dental career actually holds up, and the moves worth a look, including the hygienist path for someone drawn to the clinical work rather than to diagnosis, surgery and business ownership.
