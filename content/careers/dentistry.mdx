...
**Against, and none of it is about AI:** the genuine trade-offs are physical wear and running a business. Our index measures automation exposure, not whether a field is a comfortable living, and a family should weigh that separately. The full guide gives those honest downsides their own treatment — alongside which version of a dental career actually holds up for you, and the routes in worth a look, including the hygienist path for someone drawn to the clinical work rather than to diagnosis, surgery and business ownership.
