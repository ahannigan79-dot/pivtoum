**The short answer, if you work in dentistry: your exposure is close to settled, and it's low.** Precise physical work on an anxious person, comprehensively licensed, with practice ownership as a realistic destination. The genuine trade-offs are physical wear and running a business, not automation.
...
On AI exposure it is close to settled, and the score points the same way for everyone in the field: the object-making is automating and the person-treating is not, so the safe ground is at the chair. The genuine considerations are different.
...
**Against, and none of it is about AI:** the genuine trade-offs are physical wear and running a business. Our index measures automation exposure, not whether a field is a comfortable living, and that's worth weighing separately. Inside the community, those honest downsides get their own treatment in the Learn library — alongside which version of a dental career actually holds up, and the moves worth a look, including the hygienist path for someone drawn to the clinical work rather than to diagnosis, surgery and business ownership.
...
## What's in your dentistry AI Exposure Report
This report tells you where dentistry stands. The community is how you act on it.
