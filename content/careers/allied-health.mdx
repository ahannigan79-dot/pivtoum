...
These are the familiar non-AI ones — what the doctorate cost against the salary, and physical work over decades. The community gives those honest downsides their own treatment in the Learn library, alongside which versions of the path actually hold up and where the room to move is.
