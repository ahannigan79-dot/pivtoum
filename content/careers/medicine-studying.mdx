**The short answer, if you're weighing whether to study medicine: yes, it remains one of the safest paths available** — but for the first time, choice of specialty carries an AI dimension. Enter medical school today and you'll choose a specialty in five or six years, and the specialties are no longer moving together.
...
The reasons people hesitate about medicine have not changed and have nothing to do with AI — the length and cost of training, the punishing early-career hours, the repeated relocations, and burnout. You should understand that timeline concretely before committing to it.

A low AI score does not mean an easy path. The community goes there honestly — the downsides, and what doctors themselves say about the work — mapped to where you actually stand.
