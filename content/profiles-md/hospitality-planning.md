...
The honest problem is equally straightforward, and it's the highest turnover of any industry in the United States. That combination — a wide-open door, a protected operational core, and a retention problem that ends most careers before they start — is what makes *which version you aim at, and whether you stay in it,* most of the decision in front of you.
...
**Read the table this way:** ==everything that happens in front of a guest scores below 4.4. Everything that happens in an office behind them scores above 6.6.== Which is why, with hospitality, *which version you aim at* matters more than the industry itself.
...
**The way through is the opposite of most careers in this index.** The entry rung is wide open, so the risk isn't getting in — it's getting in at the right rung. Enter through operations, where the work is protected, rather than the back office that only *looks* like the professional route (revenue management 6.6, reservations 7.4), and treat staying long enough to become experienced as the strategy — because that's where the shortage, and the pay, actually sit. The routes and the career-hunting checklist below turn that into concrete moves.
...
**The situation:** the automation in hospitality is landing on the back office, and the shortage is in experienced operators. That points to an unusually clear strategy. A path worth choosing is one that gets you onto the operational ladder, not into the administrative layer that's automating.
...
**Before committing:** ==+work a full season, including a bad one — a Christmas period, a summer peak, a difficult service.== Hospitality is romanticized and the reality is physical and relentless. It also suits some people completely.
...
**Worth knowing:** the route that holds up is the one that points at operations and the ladder above it. A route that lands you in revenue management or reservations administration — however it's titled — is choosing the 6.6–7.4 tier.
...
Choosing well is step one. This is what turns a good choice into a good outcome once you're in — worth reading *now*, because the best time to pick a path is knowing exactly what you'll need to do with it. The first list is for the training and early roles; the second is for the job hunt that follows.
...
- **Work a full season, including a bad one** — a Christmas period, a summer peak, a difficult service — before you commit. Hospitality is romanticized; a hard Saturday night answers the question quickly.
...
**The counterargument — read this one:**
  ...
  **Where we land:** both are fair. Our score measures automation exposure and nothing else, and ==+for hospitality the technology answer is straightforwardly good and the conditions answer is the hard one.== That's why the "other things to consider" section is the longest here, and why the practical advice is about choosing an employer rather than choosing the industry.

---

# Bottom line

**Hospitality is well protected from automation and it inverts the pattern in this index.** That's the good news for someone still choosing: the decision in front of you — which version, which employer, and whether you plan to stay — is exactly the one that determines the outcome.
...
And one honest thing worth saying, if the first reaction was that this isn't a real career. ==+It employs two million more people than it did in 2020, the chef population has grown nearly 80%, and it is one of very few fields where someone can start at eighteen with no qualification and be running a venue at twenty-six. The problems here are real and they are about conditions, not about ceilings.==
...
2. **Do you want to cook, to serve, or to run something?** Three different careers with different paths.
3. How do you perform under sustained time pressure? Service is a long sprint.
4. Have you worked a difficult service — a Christmas period, a summer peak?

## Reacting to the findings

5. Kitchen work scores 3.2 and reservations administration 7.4. Does that change where you'd aim?
6. **In most careers the entry tier is collapsing; in hospitality the shortage is at the top.** What do you make of that?
7. Chef numbers grew 79.6% between 2020 and 2024. Was that surprising?

## The harder conversation

8. **Turnover runs 70–80%, five times the norm, and three-quarters of it is voluntary.** What would make you one of the people who stays?
9. Schedule unpredictability is one of the top reasons people leave. Is that something you could live with?
10. Evenings, weekends and holidays are the working hours. Have you pictured that over ten years?

## Testing it against reality

11. **The most valuable single action:** work a full season including a hard one. Hospitality is romanticized, and a bad Saturday night answers the question quickly.
12. Find someone who's been in hospitality ten years and ask what kept them — and someone who left after one, and ask what didn't.

## Widening the frame

13. GM salaries rose 12.24% in a year and experienced operators are the hardest roles to fill. Does the progression picture look different from the entry pay?
14. Have you considered **culinary training or apprenticeship** specifically? Structured craft, and chef numbers are growing fast. What about **events and venue operations**, which scores 4.4?
15. If hospitality weren't available, what would you choose? The answer usually reveals whether the pull is people, pressure, food or independence.
