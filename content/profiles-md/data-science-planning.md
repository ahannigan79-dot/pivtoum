...
But demand is growing fast enough that the picture is genuinely contested, and the section on the strongest challenge to our score sets out why — which is why *which version you aim at* is most of the decision in front of you.
...
Here's how entry-level data analysis answers them. Knowing *why* the entry tier scores 8.2 while ML engineering holds 6.0 is what tells you which version of the field to aim at.
...
**The honest read.** ==+Data science has two protections, both seniority-dependent, neither inherited from the field.== Demand is doing far more work than structure here — and demand can change, while a license cannot.
...
**And there is no structural floor.** No license, no physical requirement. Whatever protection someone has, they earned personally.
...
**The situation:** this is the field where AI tooling arrived first and most completely, which means the bar for what counts as valuable has already moved. A good program should be building this fluency deliberately, not banning the tools or ignoring them.
...
**4. Own a recommendation.** Everything in this guide points at accountability. Anything that puts a graduate closer to a decision they answer for moves them up the scale.
...
Not "statistics for data science" — actual statistical reasoning, experimental design, and inference. This is the durable part.
...
Given that employers prefer two to four years' experience, the internship is how a graduate gets around the paradox.
...
**Data science is the guide where our framework and the labor market disagree most, and we've tried to give you both** — which is exactly why, for someone still choosing, the decision in front of you matters so much: which version, which program, which route in is what determines the outcome.
...
2. **Are you curious about the question, or about the technique?** The best predictor of who moves up rather than out.
3. What does a Tuesday look like in the job you're imagining?
4. Are you comfortable saying "the data can't tell us that"? Much of the value is knowing the limits.

## Reacting to the findings

5. Entry analysis scores 8.2; ML engineering 6.0. Does that change where you'd aim?
6. **BLS projects 33.5% growth — the fourth-fastest occupation in the economy.** How do you weigh that against our score?
7. This guide argues that being close to AI doesn't protect you from it. Does that land?

## The harder conversation

8. Employers prefer two to four years' experience. What's the plan for getting the first job?
9. **Have you read both the BLS page and the section on the strongest challenge to our score?** This is the guide where the disagreement matters most, and you should form your own view.
10. Entry-level salaries are rising, not falling. What does that suggest to you?

## Testing it against reality

11. **The most valuable single action:** work with real, messy data on a real question. A project, a competition, anything that isn't a clean teaching set.
12. Find someone two to three years into a data role and ask what they actually do, and what their title means at their company.
