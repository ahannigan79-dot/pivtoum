...
If your instinct on hearing "teaching" was to worry about pay and workload rather than robots, that instinct is correct. This guide will confirm it, and it will also show you something more useful: that the difficulty varies more by *where* someone teaches than by whether they teach.
...
**Read the table this way:** ==+classroom teaching's +0.4 over three years is tied for the slowest movement in the entire index.== Online instruction moved +1.3 over the same period — the same subject knowledge, the same automatable tasks, on a completely different trajectory. Which version you aim at is most of the decision in front of you.
...
**But the welcome hides a fork worth seeing now.** The same demand that makes the classroom easy to enter is easiest of all at the exposed rung — online instruction and content-based tutoring, the work that scores 6.8 and is furthest into automation. ==?The way through is to enter on the certified classroom pathway — the supervised practice, the mandated qualification, a shortage subject — rather than at whichever content-delivery rung happens to be hiring fastest.== A seat being open in online instruction is not the same as a future there; it shares the subject knowledge with the classroom and almost none of the protection.
...
==Nothing about the *work* changed. The setting did.== That single comparison is the best evidence in this index that where you do something matters more than what you know — and it's the reason the version you choose carries so much weight.
...
**During:** get classroom exposure early and often — behavior management is the thing people underestimate. Practice the verification habit deliberately.

**Choosing a subject:** ==+shortage subjects — mathematics, physics, chemistry, special education, bilingual — carry better employability, better pay and more geographic freedom.== That decision matters more than most trainees realize.
...
**Worth knowing:** the version that holds up is the certified classroom one, ideally in a shortage subject. A route that lands you in online instruction or content-based tutoring without certification is choosing the 6.8 tier, however the job is titled.
...
The single best predictor of whether someone stays. Ask how many weeks, across how many different schools.

**2. Behavior management taught properly.**
Not a module — sustained, practical, with real feedback. It's the thing new teachers report being least prepared for.

**3. Is AI treated as part of practice?**
Trainees should learn to use these tools *and* to check them, and to think about assessment design in a world where generated work is free.

**4. Placement variety.**
Different phases, different intakes, different school contexts. Given the 19.1%-versus-12.9% turnover gap, understanding what different settings are actually like matters enormously.
...
**Red flags:** minimal or late classroom exposure; behavior management as a single module; no retention data; a curriculum unchanged since 2022; no engagement with AI beyond a policy banning it.

---

# The career-hunting checklist

Choosing well is step one. This is what turns a good choice into a good outcome once you're in — worth reading *now*, because the best time to pick a program is knowing exactly what you'll need to do with it. The first list is for the training years; the second is for the job hunt that follows.
...
- **Get into classrooms early and often.** It is the single best predictor of whether someone stays, and behavior management is the thing people most underestimate. Volunteer, assist, do anything that puts you in the room before you commit.
...
Teaching is the field where *which version you choose* matters more than the subject itself — and the good news for someone still choosing is that the decisive choice is the one in front of you.
...
2. **Are you drawn to children, or to your subject?** This is the most important question here, and the two lead to very different experiences.
3. Can you hold a room? Have you ever had to — coaching, leading, running something?
4. What does a Tuesday look like in the job you're imagining?

## Reacting to the findings

5. Classroom teaching scores 3.6 and online instruction 6.8. Was that surprising?
6. The guide says teaching rates *higher* on automatability than nursing or medicine and still scores low. Does that make sense to you?
7. AI takes planning, marking and differentiation. Does that change how you feel about the job?
...
9. Behavior management is the thing new teachers report being least prepared for. What do you think your instinct would be?
10. Turnover runs at 19.1% in high-poverty schools against 12.9% in low-poverty ones. Does that change how you'd think about where to work?

## Testing it against reality

11. **The most valuable single action:** get into a classroom. Volunteering, assisting, anything. Nothing else answers the fit question as fast.
12. Find a teacher three to five years in — not one about to retire — and ask what a normal week actually looks like.

## Widening the frame

13. **Which subject?** Shortage subjects — maths, physics, chemistry, special education, bilingual — carry better employability, pay and geographic freedom. Have you weighed one?
14. Have you considered special education? It scores best in this guide at 3.1 and has the deepest shortages.
15. If teaching weren't available, what would you choose? The answer usually reveals what you're actually drawn to.
