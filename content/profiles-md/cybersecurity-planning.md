...
And the entry route everyone is pointed toward is the specific part being automated — which is why *which version you aim at* is most of the decision in front of you.
...
Here's how incident response and threat hunting answers them. Knowing *why* the entry SOC rung scores 7.4 while incident response holds 5.0 is what tells you which version of the field to aim at.
...
**We rate this 9.0, and the section on adversarial novelty explains why cybersecurity's novelty is a different kind from every other career in this index.**
...
**The situation:** security teams are adopting AI faster than they trust it. Only about one in nine trusts it completely for mission-critical work, while a third plan to use it to fill skills gaps. That gap is the opportunity. A good program should be building this fluency deliberately, not banning the tools or ignoring them.
...
**The pattern in this index holds, with a security-specific twist:** ==?roles facing the adversary directly score better than roles processing what the adversary triggered.== Cloud security, AI/ML defense and application security are named consistently as the most in-demand skills, and all three sit on the protected side of that line.
...
How many hours in actual environments, breaking and defending real systems? This is the single best differentiator.
...
Incident response, offensive security, cloud, application security. Generic security degrees place worst.
...
**Red flags:** a curriculum built around vendor tools; minimal lab time; no specialization pathways; outcomes quoted as "employed in cybersecurity"; heavy emphasis on the 4.8 million figure in the marketing.
...
**Cybersecurity is the best position in technology and a mid-table position overall — and the gap between those two statements is where most of the confusion lives.** That's the good news for someone still choosing: the decision in front of you — which version, which program, which route in — is exactly the one that determines the outcome.
...
2. **Do you think adversarially?** Do you instinctively ask how something could be abused rather than how it works? That's the defining trait, and it's usually visible early.
3. What does a Tuesday look like in the job you're imagining? What about a Tuesday at 2am during an incident?
4. How do you behave when something is going badly — calmer, or more scattered?

## Reacting to the findings

5. Incident response scores 5.0 and tier-one SOC 7.4. Does that change where you'd aim?
6. **Had you encountered the 4.8 million figure?** Where — and does the section on it change how you read it?
7. Gartner projects over half of tier-one SOC work AI-handled by 2028. What do you make of that, given it's the standard entry route?

## The harder conversation

8. **The burnout data.** 47% reporting burnout, attrition above other tech roles, on-call as a permanent feature. Have you looked at that squarely?
9. Every "entry level" posting wants two years of experience. What's the plan for getting round that?
10. Have you checked whether the programs you're considering point at SOC roles or at engineering and IR?

## Testing it against reality

11. **The most valuable single action, available tonight and free:** set up a home lab, or start capture-the-flag competitions. Nothing else demonstrates capability as directly, and almost nobody your age has any.
12. Find someone two to three years into a security role and ask what they actually do — and how often they're woken up.

## Widening the frame

13. Have you considered **computer science with a security specialization** rather than a cybersecurity degree? The engineering foundation is what verification rests on.
14. What about an **apprenticeship route**? It solves the experience paradox directly and is badly under-used.
15. If cybersecurity weren't available, what would you choose? The answer usually reveals what you're actually drawn to.
