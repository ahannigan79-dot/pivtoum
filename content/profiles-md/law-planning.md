...
Meanwhile legal employment in the United States hit a ten-year high in early 2026. Both of those things are true at once — and which version of the profession you aim at is most of the decision in front of you.
...
What resists: standing up in a courtroom, being the person a client trusts with an existential problem, judgment on a genuinely novel question, and holding the bar card and the liability that comes with it. A degree worth choosing is one that builds toward those.
...
**The gap widened from 2.2 points to 3.4.** Like software, law isn't sinking. It's splitting — which is the case for choosing the protected version deliberately rather than assuming you'll drift toward it.
...
Notably absent: speed of research, volume of drafting, and breadth of recalled authority. These were the traditional markers of a strong junior lawyer and are the fastest-depreciating. When comparing programs, it's worth checking which list the degree actually develops.
...
==That gap is the opportunity.== The tools are deployed. The people who can genuinely direct and verify them are not. A good program should be building this fluency deliberately, not banning the tools or ignoring them.
...
**3. Is the curriculum AI-native?**
Are students taught to use legal AI tools *and* to verify them? A school that bans them is training for a job that no longer exists; one that teaches them uncritically is worse.

**4. Employer relationships that are real.**
Named firms, actual placement pipelines, and honest data about who converts.

**5. The debt-to-outcome ratio.**
Total cost against realistic first-job earnings for *that school's* graduates, not the national average.
...
- **Keep the frame wide, and take the debt seriously.** Properly vet apprenticeship and earn-while-you-qualify routes — they pay rather than charge and are expanding while the traditional one narrows — and run the debt-to-outcome numbers for the specific school, not the national average, before committing money.
...
Law is not dying. It is splitting — and more sharply than any other licensed profession we measure. That's the good news for someone still choosing: the decision in front of you — which track, which school, which route — is exactly the one that determines the outcome.
...
1. What made law appealing? Push past "I like arguing" or "it's a good career" to something specific.
2. Do you want to be in a courtroom, or advising a business, or shaping policy? Those are genuinely different careers wearing the same qualification.
3. What does a Tuesday look like in the job you're imagining? Which part of the work would you like *least*?
4. Do you enjoy argument as a craft, or do you find conflict draining? The distinction matters more here than anywhere.

## Reacting to the findings

5. Trial advocacy scores 4.5 and junior document review 7.9. Does that change how you think about where you'd want to end up?
6. The guide says the bar card protects *acts*, not people. Did that land — and can you apply it to another career you're considering?
7. Legal employment is at a ten-year high while the entry route narrows. How do you make sense of those two facts together?

## The harder conversation

8. **The debt.** Have you actually run the numbers — total cost, realistic first-job earnings for *that school's* graduates, years to repay — or has it been assumed? Law salaries are bimodal; the "median" describes almost nobody.
9. What happens if the first training position doesn't come? Is there a plan, or is law the only plan?
10. The profession has persistently high rates of burnout and substance misuse, highest in the first decade. Does that change anything, and do you know why it's true?

## Testing it against reality

11. **The most valuable single action:** find a working lawyer — ideally not a family friend who'll be encouraging — and ask how they got in, whether that route would still work today, and what the first-years on their team actually do now.
12. Can you sit in on a court hearing? Public galleries are open, it costs nothing, and it demolishes a lot of assumptions in an afternoon.

## Widening the frame

13. If law weren't available, what's the closest thing you'd choose? The answer usually reveals what you're actually drawn to.
14. Do you want *law*, or what law is made of — advocacy, precision, status, argument, or helping people in trouble? Those lead to genuinely different places, some of them cheaper and shorter.
15. Have you looked at apprenticeship or earn-while-you-qualify routes where you are? They pay rather than charge, and they're expanding while the traditional route narrows.
