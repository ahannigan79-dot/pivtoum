...
The same inversion appears here as in the life sciences: **the tech-forward version of the career is more exposed than the hands-on one.** So the choice in front of you isn't "is agriculture safe" — it's which version of it you point at.

And the honest question in agriculture was never automation. It's whether the economics work — which is why *which version you choose* carries so much weight here.
...
**Read the table this way:** ==the ordering runs from hands and animals at the top to screens and data at the bottom.== That is the same pattern as every other profession in this index, and in agriculture it happens to invert the intuition about which jobs are "modern." Which is exactly why choosing the protected version deliberately matters more than the subject itself.
...
**One qualification.** This is a statement about the *analysis* role. An agronomist who walks fields, knows a specific farm over years, and is accountable for a recommendation that costs money is doing protected work. One who produces reports from platform data is not. That distinction is worth carrying into every choice you make about which version of this career to aim at.

---

# Why production work holds — the six factors

Here's how field farming and crop production answers them. Knowing *why* the field-based work holds at 4.0 while the data layer sits at 7.0 is what tells you which version of this career to choose.
...
What resists: physically operating in a field; handling livestock; fixing equipment where it broke; judging conditions; and everything that happens when the plan meets weather. A path worth choosing is one that builds toward those.
...
**Farm ownership at small scale is not a job — it's a business that frequently doesn't pay.** That is not a criticism of it; plenty of people choose it knowingly, subsidized by other income. But it's worth knowing before choosing.
...
**The gap widened from 2.9 points to 3.6.** ==-The screen-based end of agriculture is moving more than twice as fast as the field-based end== — the same pattern we find in construction, transport and life sciences. Which is the case for choosing the field-based version deliberately, rather than assuming the modern-sounding roles are the safe ones.
...
**The situation:** agriculture is the most automated sector in this index by history, and the current wave is landing on its analytical layer rather than its physical one. A good program should be building this fluency deliberately, not banning the tools or ignoring them.
...
**Before committing:** ==+work a full season, including winter. Agriculture is romanticized more than almost any career in this index, and a February morning answers the question faster than anything else.==
...
**If the interest is farming itself:** be honest about land access, and look at management, share-farming and contracting routes rather than assuming ownership. The sections below cover exactly what to ask.
...
| **Veterinary or animal science** | Regulated, protected, and covered separately in the veterinary guide. |
...
**Worth knowing:** the version that holds up is the one that keeps you physical, diagnostic and accountable. A route that lands you producing recommendations from platform data is choosing the 6.2–7.0 end, however the job is titled.
...
**The pattern in this index holds:** ==?the further from the field and the animals, the higher the exposure. Supply planning and data roles score 7.0 against livestock husbandry at 3.4.== That's the whole map, and it's worth having in mind when a program describes where its graduates end up.
...
Agriculture is learned by doing, and programs vary enormously in how much real work they involve.

**2. Technical depth in equipment and machinery.**
This is where the shortage is.

**3. Does it teach the business honestly?**
Farm financial management, given the household income data, is the most under-taught essential subject in agriculture.
...
- **Learn the business honestly.** Farm financial management, given a median household income of −$1,161 from farming, is the most under-taught essential subject in agriculture. Make sure it's compulsory, not optional.
...
Agriculture is the field where *which version you choose* matters more than the subject — and it's also the longest-running automation story in this index, one that already answered the questions every other profession is now asking.
...
2. **Do you want to *farm*, or to *work in agriculture*?** Different careers, different economics, and this is the most important question here.
3. Have you worked a full season — including winter? If not, that's the next step.
4. Are you mechanically capable? Most of modern farm work is.

## Reacting to the findings

5. Precision agtech scores 6.2 and field farming 4.0. Was that inversion surprising?
6. **Agriculture lost three-quarters of its workforce while tripling output.** What does that suggest about other sectors now automating?
7. The guide says the survivors got bigger rather than safer. Does that change how you think about scale?

## The money conversation, and it's the important one

8. **USDA forecasts the median farm household will lose money farming and earn $92,815 off the farm.** Have you sat with that?
...
11. **The most valuable single action:** work a full season on a commercial operation, including the parts nobody photographs.
12. Find someone farming at scale and someone working *in* agriculture — a technician, an agronomist, a food safety manager — and compare what they earn and what their week looks like.

## Widening the frame

13. If agriculture weren't available, what would you choose? The answer usually reveals whether the pull is the outdoors, the animals, or the independence.
14. **Have you looked at agricultural equipment technology?** Scores 3.8, chronically short of people, and physically protected.
15. What about **veterinary, animal science or food safety**? All regulated and protected, and chronically under-chosen.
