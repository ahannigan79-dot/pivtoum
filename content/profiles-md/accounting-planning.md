...
And there's a second story here that has nothing to do with technology: the profession is running a severe shortage and has just spent two years dismantling its own biggest barrier to entry. That combination — a protected licensed tier, a widening door, and an exposed rung beneath — is what makes *which version you aim at* most of the decision in front of you.
...
**But "easy to enter" hides a fork worth seeing now.** The same shortage that makes hiring easy is easiest of all at the transactional rung — the bookkeeping and routine-preparation work that scores 7.9 and 7.0 and is furthest into automation. Entering there because a seat is open is not the same as entering the career. ==?The way through is to enter on the licensed pathway — public practice, an audit seat, the supervised hours that count toward the CPA — rather than at whichever rung happens to be hiring fastest.== A door being open at the bottom is not the same as a future there.
...
**The practical instruction: check the current requirements in the specific state or country where you intend to qualify.** They have probably changed since the last time you or your school looked.
...
**The honest read.** ==+Accounting's protection is real, narrow, and entirely attached to the license.== The tier above it inherits some by proximity. The tier below it has none — which is why 5.2 and 7.9 sit in the same profession.
...
**And there's a paradox worth sitting with.** ==?The shortage is severe and the entry tier is automating at the same time. Both are true because they are happening at different levels: the profession needs licensed CPAs badly and needs bookkeepers barely at all.== Anyone who reads "accounting shortage" as a general green light has misread it.

---

# The AI-native advantage — what to actually do about it

**The situation:** accounting is further into this than most professions. Audit software, automated reconciliation and AI-assisted tax preparation are established rather than emerging. A good program should be building this fluency deliberately, not banning the tools or ignoring them.
...
**Worth knowing:** the version that holds up is the one that points at the signature. A route that lands you in transactional or routine-preparation work without a path to the license is choosing the 7.9 tier, however the job is titled.
...
**The pattern in this index holds:** roles closer to the signature and to accountability score better. ==?Management accounting sits at 6.3 rather than 5.2 precisely because nobody outside the business relies on it in the way they rely on an audit opinion.==
...
Does the program map cleanly onto the licensure requirements in the state where you intend to qualify, as those rules now stand?

**2. Internship placement rate and conversion.**
The profession recruits through internships. Ask what proportion secure one and what proportion convert.

**3. Audit and assurance depth.**
This is where the regulatory protection lives. A program light on audit is training for the exposed tier.
...
- **Choose audit and assurance depth over general business content.** That is where the regulatory protection sits. A curriculum light on audit is training for the exposed rung.
...
- **Keep the frame wide.** Properly vet the alternatives — public practice versus industry, the management-accounting route, apprenticeship and school-leaver routes — before committing. The order in which you enter them matters.
...
- **[120 vs 150: understanding the new CPA licensure pathways](https://accounting.uworld.com/blog/cpa-review/cpa-licensure-pathways/)**
  — the practical version of the same story: the three pathways as they now stand. Read this before assuming anything about how qualification works.
...
**The counterargument — read this one:**
  ...
  **Where we land:** we think this is right about the licensed tier and wrong about the tier below it, which is why we score tracks rather than professions. A shortage of *licensed CPAs* raises the value of the licensed path — exactly what this guide recommends. It does very little for bookkeeping and transactional work, where the retiring workforce is being replaced by software and offshoring rather than by people.
...
**Accounting is one of the better business-family choices, and the license is the whole argument.**
...
**And the most important recent change has nothing to do with technology.** ==Around 43 states have altered or removed the 150-hour requirement, which is a profession deliberately widening its own door at exactly the moment most are narrowing.== Anyone advising on accounting using pre-2025 assumptions is working from out-of-date information.

**So the useful advice is:** treat the license as the product rather than the degree, check the current requirements where you intend to qualify, choose audit and assurance depth over general business content, and go into public practice first because that is where the hours and the signature come from.

And one honest thing to weigh against finance or tech: the entry salary gap is real, it is substantial, and it is the profession's genuine weakness. What accounting offers in exchange is a license, a shortage, and a door that is currently getting wider rather than narrower — which is a rarer combination than it sounds.
...
2. Are you comfortable *in* detail, or just tolerant of it? Those are different, and only one sustains a career.
3. Do you want public practice or industry? Very different rhythms, and the order you enter them matters.
4. What does a Tuesday look like in the job you're imagining? What about a Tuesday in February?

## Reacting to the findings

5. Audit and CPA advisory scores 5.2; bookkeeping 7.9. Does that change where you'd aim?
6. Bookkeeping was already at 6.8 in 2023 — before generative AI. Was that surprising?
7. This guide argues accounting's license protects the *training* as well as the practice. Does that land?

## The harder conversation

8. **The salary gap.** A first-year audit associate at $55–70K against a software engineer at $90–130K. Have you looked at that squarely?
9. Busy season, January to April, every year. Have you pictured what that actually means?
10. **Have you checked the current CPA requirements where you'd qualify?** They've changed in most states, and this is the single most actionable thing in this document.

## Testing it against reality

11. **The most valuable single action:** find someone three to five years into public practice and ask what they actually did in year one, and whether that work still exists.
12. Can you get an internship or work experience at a firm? The profession recruits through them, and the shortage means access is easier than it's been in years.

## Widening the frame

13. If accounting weren't available, what would you choose? The answer usually reveals what you're actually drawn to.
14. Have you compared this properly against finance? Entry finance scores 8.0 against accounting's licensed 5.2 — the salary is better and the protection is worse.
15. Do you want *accounting*, or what accounting is made of — numbers, business understanding, a clear qualification, security? Those lead to different places.
