...
const STEPS: Step[] = [
  { n: 1, title: "Read the Welcome pack", body: "Start in the Library — a short pack on how the community works, what the Winning Loop is, and how to win here.", tag: "Library · coming soon" },
