...
export async function seedStarterPods() {
  ...
  const defs = [
    ...
    // — Product Marketing —
    { slug: "pod-launchpad",  name: "Launchpad",      crest: "🎯", lane: "Product marketing", region: myRegion,
    ...
    { slug: "pod-storyfirst", name: "Story First",    crest: "✍️", lane: "Product marketing", region: other,
    ...
    { slug: "pod-critpath",   name: "Critical Path",  crest: "🗺️", lane: "Project management", region: myRegion,
    ...
    { slug: "pod-shipit",     name: "Ship It",        crest: "📦", lane: "Project management", region: other,
