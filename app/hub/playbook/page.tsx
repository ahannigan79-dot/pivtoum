...
export default async function PlaybookPage() {
  ...
  return (
    <>
      <div className="hub-toolbar"><Link href="/hub" className="back">‹ Evolve</Link><span className="tt">The Winning Playbook</span></div>
      <div className="hub-body">
        <div className="build-hero">
          <p className="ck">The Winning Playbook</p>
        ...
        {groups.map((g, i) => (
          <section className={"pb-group aim-" + g.aim} key={g.aim}>
            <div className="pb-group-head">
              <span className="pb-aim-tag">{i + 1} of {groups.length}</span>
