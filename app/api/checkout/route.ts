  ...
  if (!process.env.STRIPE_SECRET_KEY) {
    return new NextResponse(
      `<!doctype html><meta charset="utf-8"><title>Checkout opening soon</title>` +
        `<body style="font-family:system-ui;max-width:34rem;margin:15vh auto;padding:0 1.5rem;background:#FFFFFF;color:#0B0E14;line-height:1.6">` +
        ...
        `<p><a href="/" style="color:#2F6BFF">← Back to Pivotum</a></p></body>`,
